    ...
    function(e, n, o) {
        ...
        a = function() {
            ...
            a.prototype.initialize = function() {
                var e;
                return (e = this).$element.addClass("rd-navbar").addClass(e.options.layout),
                ...
                e.addAdditionalClassToToggles(e, ".rd-navbar-original", "toggle-original", "toggle-original-elements"),
                e.applyHandlers(e),
            ...
            a.prototype.resize = function(n, o) {
                var a, s;
                return s = t ? n.getOption("deviceLayout") : n.getOption("layout"),
                a = n.$element.add(n.$clone),
                s === n.currentLayout && n.loaded || (n.switchClass(a, n.currentLayout, s),
                null != n.options.linkedElements && e.grep(n.options.linkedElements, function(t, e) {
            ...
            a.prototype.stickUp = function(t, n) {
                var o, a, s, r, i;
                return a = t.getOption("stickUp"),
                (e("html").hasClass("ios") || t.$element.hasClass("rd-navbar-fixed")) && (a = !1),
                o = t.$doc.scrollTop(),
                r = null != t.$clone ? t.$clone : t.$element,
                s = t.getOption("stickUpOffset"),
                i = "string" == typeof s ? s.indexOf("%") > 0 ? parseFloat(s) * t.height / 100 : parseFloat(s) : s,
                a ? (o >= i && !t.isStuck || o < i && t.isStuck) && (t.$element.add(t.$clone).find("[data-rd-navbar-toggle]").each(function() {
                    e.proxy(t.closeToggle, this)(t, !1)
                }).end().find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"),
                o >= i && !t.isStuck && !t.$element.hasClass("rd-navbar-fixed") ? (t.options.callbacks.onStuck && t.options.callbacks.onStuck.call(t),
                setTimeout(function() {
                    "resize" === n.type ? t.switchClass(r, "", "rd-navbar--is-stuck") : r.addClass("rd-navbar--is-stuck"),
                    t.isStuck = !0
                }, navigator.platform.match(/(Mac)/i) ? 10 : 0)) : ("resize" === n.type ? t.switchClass(r, "rd-navbar--is-stuck", "") : r.removeClass("rd-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", e.proxy(t.resizeWrap, t, n)),
                t.isStuck = !1,
                ...
                t.isStuck && (t.switchClass(r, "rd-navbar--is-stuck", ""),
                t.isStuck = !1,
                t.resizeWrap(n))),
                t
            }
            ...
            a.prototype.resizeWrap = function(t) {
                ...
                if (null == (n = this).$clone && !n.isStuck)
                    return e = n.$element.parent(),
                    n.getOption("autoHeight") ? (n.height = n.$element.outerHeight(),
                    "resize" === t.type ? (e.addClass("rd-navbar--no-transition").css("height", n.height),
                    e[0].offsetHeight,
                    e.removeClass("rd-navbar--no-transition")) : e.css("height", n.height)) : void e.css("height", "auto")
            }
            ,
            a.prototype.createNav = function(t) {
                ...
                e('<span class="rd-navbar-submenu-toggle"></span>').insertAfter(t.$element.find(".rd-navbar-nav li.rd-navbar-submenu > a")),
            ...
            a.prototype.createClone = function(t) {
                ...
                t.addAdditionalClassToToggles(t, ".rd-navbar--is-clone", "toggle-cloned", "toggle-cloned-elements"),
                t
            }
            ,
            a.prototype.closeToggle = function(t, n) {
                ...
                n.target !== this && !a.parents(r + "[data-rd-navbar-toggle]").length && !a.parents(s).length && l && c && ((o = t.$element.find(l).add(e(this))).each(function() {
                    if (!i)
                        return i = !0 === (n.target === this || e.contains(this, n.target))
                }),
                i || (o.add(this).removeClass("active"),
            ...
            a.prototype.switchToggle = function(t, n) {
                ...
                e(this).hasClass("toggle-cloned") ? (".rd-navbar--is-clone",
                o = ".toggle-cloned-elements") : (".rd-navbar-original",
                o = ".toggle-original-elements"),
                (a = this.getAttribute("data-rd-navbar-toggle")) && (t.$element.find("[data-rd-navbar-toggle]").not(this).each(function() {
                    var e;
                    if (e = this.getAttribute("data-rd-navbar-toggle"))
                        return t.$element.find(e + o).add(this).removeClass("active")
                }),
                t.$element.find(a + o).add(this).toggleClass("active")),
            ...
            a.prototype.dropdownTouch = function(t, n) {
                ...
                t.focusOnHover) {
                    if (a = !1,
                    o.hasClass("focus") && (a = !0),
                    !a)
                        return o.addClass("focus").siblings().removeClass("opened").each(t.dropdownUnfocus),
                        !1;
                    t.options.callbacks.onDropdownOver && t.options.callbacks.onDropdownOver.call(this, t)
                }
                return this
            ...
            a.prototype.dropdownOut = function(t, n) {
                ...
                clearTimeout(n),
                n = setTimeout(e.proxy(t.dropdownUnfocus, this, t), t.options.focusOnHoverTimeout)),
                this
            }
            ,
            ...
            a.prototype.dropdownClose = function(t, n) {
                return n.target === this || e(n.target).parents(".rd-navbar-submenu").length || (e(this).find("li.focus").add(this).removeClass("focus").removeClass("opened"),
            ...
            a.prototype.goToAnchor = function(t, n) {
                ...
                return a = this.hash,
                o = e(a),
                !!t.getOption("anchorNav") && (o.length && (n.preventDefault(),
            ...
            a.prototype.activateAnchor = function(t) {
                ...
                !s.options.anchorNav)
                    return !1;
                if (u + h > r - 50)
                    return (n = e('[data-type="anchor"]').last()).length && n.offset().top >= u && (i = "#" + n.attr("id"),
                    (o = e('.rd-navbar-nav a[href^="' + i + '"]').parent()).hasClass("active") || (o.addClass("active").siblings().removeClass("active"),
                    s.options.callbacks.onAnchorChange && s.options.callbacks.onAnchorChange.call(n[0], s))),
                    n;
                d = e('.rd-navbar-nav a[href^="#"]').get();
                for (l in d)
                    c = d[l],
                    i = (a = e(c)).attr("href"),
                    (n = e(i)).length && n.offset().top + p <= u && n.offset().top + n.outerHeight() > u && (a.parent().addClass("active").siblings().removeClass("active"),
                    s.options.callbacks.onAnchorChange && s.options.callbacks.onAnchorChange.call(n[0], s));
                return null
            }
            ,
            ...
            a.prototype.applyHandlers = function(t) {
                ...
                t.$element.add(t.$clone).find("[data-rd-navbar-toggle]").each(function() {
                    var n;
                    return (n = e(this)).on("click", e.proxy(t.switchToggle, this, t)),
                    n.parents("body").on("click", e.proxy(t.closeToggle, this, t))
                }),
                t.$element.add(t.$clone).find(".rd-navbar-submenu").each(function() {
                    var n, o;
                    return n = e(this),
                    o = n.parents(".rd-navbar--is-clone").length ? t.cloneTimer : t.focusTimer,
                    n.on("mouseleave.navbar", e.proxy(t.dropdownOut, this, t, o)),
                    n.find("> a").on("mouseenter.navbar", e.proxy(t.dropdownOver, this, t, o)),
                    n.find("> a").on("touchstart.navbar", e.proxy(t.dropdownTouch, this, t, o)),
                    n.find("> .rd-navbar-submenu-toggle").on("click", e.proxy(t.dropdownToggle, this, t)),
                    n.parents("body").on("click", e.proxy(t.dropdownClose, this, t))
                }),
                ...
                t.$element.find(".rd-navbar-dropdown, .rd-navbar-megamenu").each(function() {
                    var t, n;
                    t = e(this),
                    (n = this.getBoundingClientRect()).left + t.outerWidth() >= o.innerWidth - 10 ? this.className += " rd-navbar-open-left" : n.left - t.outerWidth() <= 10 && (this.className += " rd-navbar-open-right")
                }),
                t
            }
            ,
            a.prototype.switchClass = function(t, n, o) {
                var a;
                return (a = t instanceof jQuery ? t : e(t)).addClass("rd-navbar--no-transition").removeClass(n).addClass(o),
                a[0].offsetHeight,
